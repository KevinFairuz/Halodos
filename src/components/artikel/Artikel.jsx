...
const Artikel = () => {
  return (
    <div className="artikel container w-full items-center justify-center lg:container min-h-100%">
      ...
      <div className="ccontainer relative min-w-screen flex flex-nowrap grid grid-cols-1 md:grid-cols-3 top-20 justify-content space-x-6">
        <Card className="max-w-[24rem] overflow-hidden">
          ...
          <CardFooter className="flex items-center justify-between">
            <div className="flex items-center -space-x-3" id="artikel">
